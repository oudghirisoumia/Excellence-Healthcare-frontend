          ...
          <div className="orders-list">
            {orders.map((order) => (
              ...
              >
                ...
                <p className="order-total">{order.total.toFixed(2)} DH</p>
              </div>
            ))}
          </div>
            ...
            <div className="order-details">
              ...
              <div className="order-info">
                ...
                <div className="info-section">
                  ...
                  <p>
                    <strong>Sous-total:</strong> {selectedOrder.subtotal.toFixed(2)} DH
                  </p>
                  <p>
                    <strong>Livraison:</strong> {selectedOrder.deliveryFee.toFixed(2)} DH
                  </p>
                  <p className="total">
                    <strong>Total:</strong> {selectedOrder.total.toFixed(2)} DH
                  </p>
                </div>
