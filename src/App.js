...
import About from "./components/About"
import AdminLayout from "./components/AdminLayout"
import B2BDashboardWidget from "./components/B2BDashboardWidget"  // correction PascalCase
    ...
    <>
      ...
      <main className="container">
        <Routes>
          ...
          {/* Dashboard component widget */}
          <Route path="/dashboard" element={<B2BDashboardWidget />} />
        </Routes>
      </main>
